...
const es: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Cargos, pedidos, seguridad y familia.",
...
const en: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Charges, orders, security, and family.",
...
const fr: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Frais, commandes, sécurité et famille.",
...
const it: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Addebiti, ordini, sicurezza e famiglia.",
...
const pt: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Cargos, encomendas, segurança e família.",
