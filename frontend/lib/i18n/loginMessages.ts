...
const es: Record<LoginMessageKey, string> = {
  ...
  heroHeadline: "IA que te dice qué hacer después con tu correo",
  heroSubline: "Un enunciado por correo: cargos, pedidos, seguridad, familia.",
...
const en: Record<LoginMessageKey, string> = {
  ...
  heroHeadline: "AI that tells you what to do next with your email",
  heroSubline: "One line per email: charges, orders, security, family.",
...
const fr: Record<LoginMessageKey, string> = {
  ...
  heroHeadline: "IA qui vous dit quoi faire ensuite avec votre e-mail",
  heroSubline: "Un énoncé par e-mail : frais, commandes, sécurité, famille.",
...
const it: Record<LoginMessageKey, string> = {
  ...
  heroHeadline: "IA che ti dice cosa fare dopo con la tua email",
  heroSubline: "Un enunciato per email: addebiti, ordini, sicurezza, famiglia.",
...
const pt: Record<LoginMessageKey, string> = {
  ...
  heroHeadline: "IA que te diz o que fazer a seguir com o teu correio",
  heroSubline: "Um enunciado por correio: cargos, encomendas, segurança, família.",
