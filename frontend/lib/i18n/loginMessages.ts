...
const es: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Correos importantes, tareas y pendientes en un solo lugar.",
...
const fr: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Courriers importants, tâches et suivis au même endroit.",
...
const it: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Email importanti, attività e pendenti in un solo posto.",
...
const pt: Record<LoginMessageKey, string> = {
  ...
  heroSubline: "Correios importantes, tarefas e pendências num só lugar.",
