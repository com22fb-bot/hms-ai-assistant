const strings = {
  es: {
    ...
    nav_how: "Cómo",
    nav_app: "Abrir app",
    kicker: "Correo del hogar",
    hero_title: "Donexto",
    hero_tagline: "Do Next To… lo siguiente que sí importa.",
    hero_lede:
      "Consola de inteligencia sobre Gmail y Yahoo. Cargos, seguridad, envíos y familia en primer plano; promociones fuera de la vista. No es otra bandeja.",
    ...
    trust_3: "Casa, escuela y lo personal",
    video_title: "El criterio, en 40 segundos",
    video_lede: "Se dice Do-NEX-to. Recorre la marca, la casa y la consola.",
    ...
    story_vo_full:
      "Donexto. Do Next To… Inteligencia sobre el correo del hogar. Cargos, seguridad, envíos y familia. Google autentica en su sitio; Yahoo, con tu correo y tu clave. Confirmas, autorizas la lectura y la consola te muestra qué sigue. app.donexto.com",
    scope_title: "Qué mira",
    scope_lede: "Cuatro frentes. Un solo criterio. Nada de jerga de oficina.",
    scope_1_t: "Dinero",
    scope_1_p:
    ...
    scope_3_t: "Envíos",
    scope_3_p: "Paquetes, citas de entrega y lo que viene camino a casa.",
    scope_4_t: "Familia",
    scope_4_p:
      "Escuela, salud, hogar y lo personal. El correo de la casa no es un producto corporativo.",
    levels_title: "Tres ritmos",
    levels_lede:
      "No cada mensaje merece un aviso. El sistema decide cuándo interrumpir y cuándo callar.",
    n1_badge: "N1 · Ahora",
    n1_title: "Interrumpe",
    n1_p: "Pagos, acceso a cuentas, entregas y avisos de escuela. Candidato a alerta en el celular.",
    n1_hint: "",
    ...
    proto_c_t: "Operación",
    market_title: "Por qué el correo de casa",
    market_lede:
      "En el hogar la bandeja no es un chat: es control de pagos, envíos y gente. La mayor parte del volumen es oferta. Donexto enseña solo lo que sí vale interrumpir.",
    stat1_v: "N1 alto",
  ...
  en: {
    ...
    nav_how: "How",
    nav_app: "Open app",
    kicker: "Household email",
    hero_title: "Donexto",
    hero_tagline: "Do Next To… the next thing that actually matters.",
    hero_lede:
      "An intelligence console over Gmail and Yahoo. Charges, security, deliveries, and family up front; promotions out of sight. Not another inbox.",
    ...
    trust_3: "Home, school, and personal life",
    video_title: "The signal, in 40 seconds",
    video_lede: "Say Do-NEX-to. Brand, household, console.",
    ...
    story_vo_full:
      "Donexto. Do Next To… Intelligence over household email. Charges, security, deliveries, and family. Google signs in on Google’s site; Yahoo with your email and password. You confirm, authorize reading, and the console shows what to do next. app.donexto.com",
    scope_title: "What it watches",
    scope_lede: "Four fronts. One standard. No office jargon.",
    scope_1_t: "Money",
    ...
    scope_3_t: "Deliveries",
    scope_3_p: "Packages, delivery windows, and what’s on the way home.",
    scope_4_t: "Family",
    scope_4_p: "School, health, home, and personal life. Household mail is not a corporate product.",
    levels_title: "Three tempos",
    levels_lede:
      "Not every message earns an alert. The system chooses when to interrupt and when to stay quiet.",
    n1_badge: "N1 · Now",
    n1_title: "Interrupts",
    n1_p: "Payments, account access, deliveries, and school notices. Push-candidate on the phone.",
    n1_hint: "",
    ...
    market_title: "Why household email",
    market_lede:
      "At home the inbox is not chat: it is control of payments, deliveries, and people. Most volume is offers. Donexto surfaces only what is worth interrupting.",
    stat1_v: "High N1",
  ...
  es: [
    {
      ...
      label: "01 · 0:00–0:06",
      chapter: "Marca",
      line: "Donexto. Do Next To… Inteligencia sobre el correo del hogar.",
    ...
    },
    {
      ...
      label: "02 · 0:06–0:14",
      chapter: "Casa",
      line: "Cargos, seguridad, envíos y familia. El resto espera.",
  ...
  en: [
    {
      ...
      label: "01 · 0:00–0:06",
      chapter: "Brand",
      line: "Donexto. Do Next To… Intelligence over household email.",
      html: `<img class="vis-photo" src="./brand-youtube.jpg" alt="" />`,
    },
    {
      id: "para-quien",
      ...
      label: "02 · 0:06–0:14",
      chapter: "Home",
      line: "Charges, security, deliveries, and family. Everything else waits.",
      html: `<img class="vis-photo wide" src="./brand-escritorio.jpg" alt="" />`,
    },
    {
      id: "google",
