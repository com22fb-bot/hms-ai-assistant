const strings = {
  es: {
    ...
    hero_lede:
      "Donexto (Do Next To…) es tu capa de atención sobre el correo personal — Gmail, Outlook, Yahoo e iCloud: el mensaje que importa a tu trabajo, negocio y profesión, para que sepas qué hacer ahora.",
    ...
    trust_1: "Gmail, Outlook, Yahoo e iCloud",
    ...
    video_lede:
      "Qué hace Donexto (se dice Do-NEX-to, nunca “Donextu”). Dale play: capa de atención, Gmail, Outlook, Yahoo e iCloud, verificación y priorización del correo que mueve tu trabajo.",
    video_caption:
  ...
  en: {
    ...
    hero_lede:
      "Donexto (Do Next To…) is your attention layer on personal email — Gmail, Outlook, Yahoo, and iCloud: the message that matters to your work, business, and profession—so you know what to do next.",
    cta_app: "Open Donexto",
    cta_video: "Watch story",
    cta_app2: "Try app.donexto.com",
    cta_app3: "Open app.donexto.com",
    cta_mail: "support@donexto.com",
    trust_1: "Gmail, Outlook, Yahoo, and iCloud",
    ...
    video_lede:
      "What Donexto does (say Do-NEX-to, never “Donextu”). Play: attention layer, Gmail, Outlook, Yahoo, and iCloud, verification, and prioritizing the mail that moves your work.",
    video_caption:
...
const storyShots = {
  es: [
    ...
    },
    {
      ...
      label: "03 · 0:14–0:22",
      chapter: "Buzón",
      line: "Gmail, Outlook, Yahoo e iCloud. Nunca escribes la contraseña de ese buzón en Donexto (salvo la de aplicación IMAP).",
      html: `
        <div class="vis-steps">
          <div class="vis-step"><span>1</span><strong>Gmail · Outlook</strong><p style="margin:.35rem 0 0;color:var(--muted);font-size:.85rem">Yahoo · iCloud</p></div>
  ...
  en: [
    ...
    },
    {
      ...
      label: "03 · 0:14–0:22",
      chapter: "Mailbox",
      line: "Gmail, Outlook, Yahoo, and iCloud. You never type that mailbox password on Donexto (except an app password when IMAP requires it).",
      html: `
        <div class="vis-steps">
          <div class="vis-step"><span>1</span><strong>Gmail · Outlook</strong><p style="margin:.35rem 0 0;color:var(--muted);font-size:.85rem">Yahoo · iCloud</p></div>
